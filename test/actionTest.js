...
var TokenProportionalCappedTest = artifacts.require(
  "electusvoting/contracts/testContracts/TokenProportionalCappedTest.sol"
);
var TokenProportionalUncappedTest = artifacts.require(
  "electusvoting/contracts/testContracts/TokenProportionalUncappedTest.sol"
);
var ElectusProtocol = artifacts.require(
  "electusvoting/contracts/protocol/Protocol.sol"
);
var TestToken = artifacts.require(
  "electusvoting/contracts/Token/FreezableToken.sol"
);
...
contract("Action Test", function(accounts) {
  beforeEach("setup", async () => {
    ...
    actionContract = await ActionTest.new(
      [pollContract1.address, pollContract2.address],
      accounts[0]
    );
